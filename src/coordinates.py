# originally from http://wiki.python.org/moin/PointsAndRectangles
...
class Point(CommonEqualityMixin):
    ...
    def __eq__(self, other):
        # this method is a hack introduced due to slight floating 
        # point variataions. This solution should be revisited.
        # http://www.cygnus-software.com/papers/comparingfloats/comparingfloats.htm
        # http://stackoverflow.com/questions/3049101/floating-point-equality-in-python-and-in-general
        #
        if type(other) is type(self):
            
            xDiff=math.fabs(self.x-other.x)
            yDiff=math.fabs(self.y-other.y)
    ...
    def rotate(self, theta):
        ...
        """
        #rad = float(math.radians(theta))
        #s, c = [f(rad) for f in (math.sin, math.cos)]
        s, c = [f(math.radians(theta)) for f in (math.sin, math.cos)]
